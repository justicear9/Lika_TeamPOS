...
@section('title', __('accounting::lang.cash_flow'))
...
<section class="content">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            {!! Form::select('location_id', $business_locations, $location_id, ['class' => 'form-control select2', 'id' => 'location_id_cf', 'placeholder' => __('accounting::lang.all_locations'), 'style' => 'width:100%']); !!}
        </div>
    </div>
    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="box box-warning">
            <div class="box-header with-border text-center">
                <h2 class="box-title">@lang( 'accounting::lang.cash_flow')</h2>
                ...
                <table class="table table-stripped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-right">@lang('accounting::lang.net_cash_movement')</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($rows as $row)
                        <tr>
                            ...
                            <td class="text-right">@format_currency($row->net_cash)</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#location_id_cf').change(function () {
            apply_filter();
        });
    });
