...
<section class="content">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            {!! Form::select('location_id', $business_locations, $location_id, ['class' => 'form-control select2', 'id' => 'location_id', 'placeholder' => __('accounting::lang.all_locations'), 'style' => 'width:100%']); !!}
        </div>
    </div>
                ...
                <table class="table table-stripped">
                    ...
                    <tbody>
                        ...
                        @endphp
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('accounting.ledger', $account->account_id) }}?start_date={{ $start_date }}&end_date={{ $end_date }}@if($location_id !== null && $location_id !== '')&location_id={{ $location_id }}@endif">
                                        @if(!empty($account->gl_code)){{ $account->gl_code }} — @endif{{ $account->name }}
                                    </a>
                                </td>
                                <td>
