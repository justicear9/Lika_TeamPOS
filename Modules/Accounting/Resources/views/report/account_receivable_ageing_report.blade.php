        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="box box-warning">
                <div class="box-header with-border">
                    <h2 class="box-title text-center" style="width: 100%;">@lang( 'accounting::lang.account_recievable_ageing_report' )</h2>
                    <div class="box-tools pull-right">
                        @include('accounting::report.partials.export_excel_button', ['export_route' => 'accounting.account_receivable_ageing_report.export'])
                    </div>
                </div>
                <div class="box-body">
