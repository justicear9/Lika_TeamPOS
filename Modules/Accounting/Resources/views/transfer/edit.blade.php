  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            {!! Form::select('location_id', $business_locations, $debit_tansaction->location_id, ['class' => 'form-control select2', 'placeholder' => __('accounting::lang.all_locations'), 'style' => 'width:100%']); !!}
        </div>
