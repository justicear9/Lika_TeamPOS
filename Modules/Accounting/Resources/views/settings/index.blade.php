				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="account_setting">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									{!! Form::label('fixed_asset_code_prefix', __('accounting::lang.fixed_asset_code_prefix') . ':') !!}
									@show_tooltip(__('accounting::lang.fixed_asset_code_prefix_help'))
									{!! Form::text('fixed_asset_code_prefix', !empty($accounting_settings['fixed_asset_code_prefix']) ? $accounting_settings['fixed_asset_code_prefix'] : '', ['class' => 'form-control', 'id' => 'fixed_asset_code_prefix', 'placeholder' => 'FA']); !!}
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									{!! Form::label('accounting_period_lock_end', __('accounting::lang.accounting_period_lock_end') . ':') !!}
									@show_tooltip(__('accounting::lang.accounting_period_lock_end_help'))
									{!! Form::text('accounting_period_lock_end', !empty($accounting_settings['accounting_period_lock_end']) ? $accounting_settings['accounting_period_lock_end'] : '', ['class' => 'form-control datepicker', 'id' => 'accounting_period_lock_end', 'placeholder' => 'YYYY-MM-DD']); !!}
								</div>
							</div>
						</div>
