        ...
        <div class="col-md-7">
            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            {!! Form::label('ledger_location_id', __('accounting::lang.location') . ':') !!}
                            {!! Form::select('ledger_location_id', $business_locations, $location_id ?? null, ['class' => 'form-control select2', 'id' => 'ledger_location_id', 'placeholder' => __('accounting::lang.all_locations'), 'style' => 'width:100%']); !!}
                        </div>
                    </div>
...
<script>
    $(document).ready(function(){        
        ...
        $('#ledger_location_id').change(function(){
            var u = new URL(window.location.href);
            if ($(this).val()) {
                u.searchParams.set('location_id', $(this).val());
            } else {
