        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    @endif
                    @if(auth()->user()->can('accounting.view_fixed_assets'))
                        <li @if(request()->segment(2) == 'fixed-assets') class="active" @endif>
                            <a href="{{ route('accounting.fixedAssets.index') }}">
                                @lang('accounting::lang.fixed_assets')
                            </a>
                        </li>
                    @endif
                    ...
                    <li @if(request()->segment(2) == 'bank-reconciliation') class="active" @endif>
                        <a href="{{ route('accounting.bankReconciliation.index') }}">@lang('accounting::lang.bank_reconciliation')</a>
                    </li>
                    @endcan
