...
class DataController extends Controller
{
    ...
    public function user_permissions()
    {
        return [
            ...
            [
                'value' => 'accounting.reconcile',
                'label' => __('accounting::lang.bank_reconciliation'),
                'default' => false,
            ],
            [
                'value' => 'accounting.import_bank_statement',
                'label' => __('accounting::lang.import_bank_statement'),
                'default' => false,
            ],
            [
                'value' => 'accounting.view_audit_log',
                'label' => __('accounting::lang.audit_log'),
                'default' => false,
            ],
            [
                'value' => 'accounting.view_fixed_assets',
                'label' => __('accounting::lang.fixed_assets'),
                'default' => false,
            ],
            [
                'value' => 'accounting.manage_fixed_assets',
                'label' => __('accounting::lang.manage_fixed_assets'),
                'default' => false,
            ],
            [
                'value' => 'accounting.run_depreciation',
                'label' => __('accounting::lang.run_depreciation'),
                'default' => false,
            ],
        ];
    }
