...
class TransferController extends Controller
{
    ...
    public function create()
    {
        ...
        if (request()->ajax()) {
            ...
            return view('accounting::transfer.create', compact('business_locations'));
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $this->accountingUtil->assertOperationDateNotLocked($business_id, $date);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($this->accountingUtil->isOperationDateLocked($business_id, $mapping_transaction->operation_date)) {
                return ['success' => 0,
            ...
            AccountingAuditService::log(
                ...
                (int) $id,
                null,
                ['ref_no' => $mapping_transaction->ref_no]
            );
    ...
    public function destroy($id)
    {
        ...
        if ($this->accountingUtil->isOperationDateLocked($business_id, $acc_trans_mapping->operation_date)) {
            return ['success' => 0,
                'msg' => __('accounting::lang.period_locked'),
            ];
        }
