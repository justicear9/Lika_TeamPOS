...
@section('content')
    ...
    <section class="content">
        ...
        @if(isset($campaignsms_token_balance))
        <div
            ...
            <div class="tw-p-4 sm:tw-p-5">
                <div class="tw-flex tw-gap-2.5">
                    <strong><i class="fa fa-commenting margin-r-5"></i>
                        @lang('campaignsms::lang.sms_token_balance')</strong>
                </div>
                <p class="tw-mt-2 tw-text-muted">{{ $campaignsms_token_balance }} @lang('campaignsms::lang.tokens')</p>
                <a href="{{ route('campaignsms.superadmin.tokens', ['business_id' => $business->id]) }}" class="btn btn-sm btn-primary">
                    @lang('campaignsms::lang.manage_sms_tokens')
                </a>
            </div>
        </div>
        @endif
