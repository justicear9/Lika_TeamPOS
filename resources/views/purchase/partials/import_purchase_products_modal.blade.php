			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-12 mt-10">
						...
						<a href="{{ asset('files/import_purchase_products_template.csv') }}" class="tw-dw-btn tw-dw-btn-success tw-text-white tw-ml-2" download><i class="fa fa-download"></i> @lang('lang_v1.download_template_file') (CSV)</a>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						...
						<table class="table table-striped">
		                    ...
		                    <tr>
		                    	<td>9</td>
		                        <td>@lang('purchase.unit_selling_price') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
