    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (!empty($input['products'])) {
                ...
                $input = $this->moduleUtil->mergeTransactionInputFromModules($input, $request, 'sell_return.store', (int) $business_id);
                ...
                $this->moduleUtil->getModuleData('after_sales_return', ['transaction' => $sell_return, 'input' => $input]);
